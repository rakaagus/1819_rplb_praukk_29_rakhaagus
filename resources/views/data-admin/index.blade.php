    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6 pb-3 pr-lg-0">
            <div class="box rounded" style="background-color: #EC4953">
                <div class="row">
                    <div class="col-6 col-lg-5 col-xl-6">
                        <h6 class="pl-3 pt-5 text-white">Kelola Transaksi</h6>
                    </div>
                    <div class="col-6">
        ...
        <div class="col-lg-3 col-6 pb-3">
            <div class="box bg-primary rounded">
                <div class="row">
                    <div class="col-6 col-lg-5 col-xl-6">
                        <h6 class="pl-3 pt-5 text-white">Hasil Pejualan</h6>
                    </div>
                    <div class="col-6">
                        <i class="fas fa-clipboard icon py-3" style="font-size: 70px;"></i>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
