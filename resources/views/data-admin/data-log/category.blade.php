...
<div class="container-fluid mb-5" style="min-height: 82.5vh;">
    <h3 class=" py-3"><i class="fas fa-cookie mr-2 pt-4 pb-2" style="size: 2px"></i>Category Logs</h3>

    <div class="card shadow">
        <div class="card-header bg-white">
            <div class="row">
                <div class="col text-right">
                    <a href="{{ route('product-log') }}" class="btn btn-primary btn-md" >Product Logs</a>
