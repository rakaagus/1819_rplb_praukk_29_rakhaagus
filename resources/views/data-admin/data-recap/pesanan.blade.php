...
<div class="container-fluid mb-5" style="min-height: 82.5vh;">
    ...
    <div class="card mb-2">
        ...
        <div class="card-body">
            <form action="{{ route('cek_laporan') }}" method="POST">
                @csrf
                ...
                <div class="form-group row ml-auto">
                    <div class="col-4">
                        ...
                        <a href="{{ route('recap-pesanan') }}" class="btn btn-info text-white">Refresh</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow">
        <div class="card-header bg-white">
            <div class="row">
                <div class="col">
                    <span style="font-size: 18px;">Recap Pesanan</span>
                </div>
