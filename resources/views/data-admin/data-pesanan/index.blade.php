        ...
        <div class="modal-body">
          <form action="{{ route('category.store') }}" method="post">
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="status" name="" class="custom-control-input" value="1">
                <label class="custom-control-label" for="status"><span class="badge badge-primary">Sampai</span></label>
              </div>               --}}
